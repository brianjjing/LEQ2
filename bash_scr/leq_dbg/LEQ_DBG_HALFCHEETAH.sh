...
# GORMPO/configs/<estimator>/gormpo_halfcheetah_medium_expert_sparse_3.yaml
#
# Pipeline (per seed):
...
#   bash bash_scr/leq_dbg/LEQ_DBG_HALFCHEETAH.sh
#   CUDA_VISIBLE_DEVICES=2 DBG_TYPES="kde ddpm" bash bash_scr/leq_dbg/LEQ_DBG_HALFCHEETAH.sh
#
# Env overrides:
...
CONFIG_TAG="halfcheetah_medium_expert_sparse_3"  # GORMPO's config filename stem for this dataset
...
echo "============================================"
echo "LEQ + DBG: $TASK (sparse HalfCheetah)"
