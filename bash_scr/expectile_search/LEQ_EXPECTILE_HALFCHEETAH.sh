#!/bin/bash
set -e
# Expectile hyperparameter search for LEQ on sparse HalfCheetah-Medium-Expert,
...
#   GPUs 4-7, one per expectile value.
#
# Usage (from LEQ2 root):
#   bash bash_scr/expectile_search/LEQ_EXPECTILE_HALFCHEETAH.sh
#
# Env overrides:
...
echo "============================================"
echo "LEQ expectile search on sparse HalfCheetah (no guardian)"
echo "  Env task:      $TASK"
