...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["walker2d-m-e-sparse"]["DDPM"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_WALKER2D_DDPM.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["walker2d-m-e-sparse"]["DDPM"].
COEF="${COEF:-0.05}"
...
echo "============================================"
echo "LEQ + DBG (DDPM) seed sweep on sparse Walker2D"
echo "  Env task:      $TASK"
