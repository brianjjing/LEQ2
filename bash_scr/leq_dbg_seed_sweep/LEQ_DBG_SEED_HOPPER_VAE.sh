...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["hopper-m-e-sparse"]["VAE"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_HOPPER_VAE.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["hopper-m-e-sparse"]["VAE"].
COEF="${COEF:-0.3}"
...
echo "============================================"
echo "LEQ + DBG (VAE) seed sweep on sparse Hopper"
echo "  Env task:      $TASK"
