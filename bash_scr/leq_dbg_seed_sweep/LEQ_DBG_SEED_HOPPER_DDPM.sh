...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["hopper-m-e-sparse"]["DDPM"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_HOPPER_DDPM.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["hopper-m-e-sparse"]["DDPM"].
COEF="${COEF:-0.05}"
...
echo "============================================"
echo "LEQ + DBG (DDPM) seed sweep on sparse Hopper"
echo "  Env task:      $TASK"
