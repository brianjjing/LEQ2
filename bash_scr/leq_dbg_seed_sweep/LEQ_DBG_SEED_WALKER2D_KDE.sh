...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["walker2d-m-e-sparse"]["KDE"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_WALKER2D_KDE.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["walker2d-m-e-sparse"]["KDE"].
COEF="${COEF:-0.5}"
...
echo "============================================"
echo "LEQ + DBG (KDE) seed sweep on sparse Walker2D"
echo "  Env task:      $TASK"
