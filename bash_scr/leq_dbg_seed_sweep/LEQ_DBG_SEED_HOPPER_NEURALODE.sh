...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["hopper-m-e-sparse"]["NeuralODE"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_HOPPER_NEURALODE.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["hopper-m-e-sparse"]["NeuralODE"].
COEF="${COEF:-0.5}"
...
echo "============================================"
echo "LEQ + DBG (NeuralODE) seed sweep on sparse Hopper"
echo "  Env task:      $TASK"
