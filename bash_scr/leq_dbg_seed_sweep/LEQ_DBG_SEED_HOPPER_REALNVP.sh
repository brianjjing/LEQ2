...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["hopper-m-e-sparse"]["RealNVP"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_HOPPER_REALNVP.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["hopper-m-e-sparse"]["RealNVP"].
COEF="${COEF:-0.8}"
...
echo "============================================"
echo "LEQ + DBG (RealNVP) seed sweep on sparse Hopper"
echo "  Env task:      $TASK"
