...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["halfcheetah-m-e-sparse"]["VAE"]).
#
# GPU layout (default): GPUs 1-3.
#
# Usage (from LEQ2 root):
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_HALFCHEETAH_VAE.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["halfcheetah-m-e-sparse"]["VAE"].
COEF="${COEF:-0.1}"
...
echo "============================================"
echo "LEQ + DBG (VAE) seed sweep on sparse HalfCheetah"
echo "  Env task:      $TASK"
