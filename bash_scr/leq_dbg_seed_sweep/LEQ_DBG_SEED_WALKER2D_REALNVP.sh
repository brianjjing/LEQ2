...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["walker2d-m-e-sparse"]["RealNVP"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_WALKER2D_REALNVP.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["walker2d-m-e-sparse"]["RealNVP"].
COEF="${COEF:-0.8}"
...
echo "============================================"
echo "LEQ + DBG (RealNVP) seed sweep on sparse Walker2D"
echo "  Env task:      $TASK"
