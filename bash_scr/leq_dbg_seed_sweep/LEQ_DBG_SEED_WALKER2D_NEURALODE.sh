...
#      fixed reward_penalty_coef (from LAMBDA_TABLE["walker2d-m-e-sparse"]["NeuralODE"]).
#
...
#   bash bash_scr/leq_dbg_seed_sweep/LEQ_DBG_SEED_WALKER2D_NEURALODE.sh
#
# Env overrides:
...
# Fixed reward_penalty_coef -- LAMBDA_TABLE["walker2d-m-e-sparse"]["NeuralODE"].
COEF="${COEF:-0.05}"
...
echo "============================================"
echo "LEQ + DBG (NeuralODE) seed sweep on sparse Walker2D"
echo "  Env task:      $TASK"
