...
# sparse Hopper (78% sparse), SEED 42 ONLY.
#
...
#
# GPU layout (fixed): GPUs 0-3 -- NOTE: the walker2d search scripts also default to GPUs
...
#   bash bash_scr/leq_dbg_penalty_search/LEQ_DBG_SEARCH_HOPPER_DDPM.sh
#
# Env overrides:
...
echo "============================================"
echo "LEQ + DBG (DDPM) reward_penalty_coef search on sparse Hopper"
echo "  Env task:      $TASK"
